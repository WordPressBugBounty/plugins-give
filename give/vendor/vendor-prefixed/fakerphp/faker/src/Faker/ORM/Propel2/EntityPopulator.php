...
namespace Give\Vendors\Faker\ORM\Propel2;
...
class EntityPopulator
{
     ...
     * @return array
     */
    public function guessColumnFormatters(\Give\Vendors\Faker\Generator $generator)
    {
        $formatters = [];
        $class = $this->class;
        $peerClass = $class::TABLE_MAP;
        $tableMap = $peerClass::getTableMap();
        $nameGuesser = new \Give\Vendors\Faker\Guesser\Name($generator);
        $columnTypeGuesser = new \Give\Vendors\Faker\ORM\Propel2\ColumnTypeGuesser($generator);
     ...
     * @return array
     */
    public function guessModifiers(\Give\Vendors\Faker\Generator $generator)
    {
        $modifiers = [];
        $class = $this->class;
        $peerClass = $class::TABLE_MAP;
