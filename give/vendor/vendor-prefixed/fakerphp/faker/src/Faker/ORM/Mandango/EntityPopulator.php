...
class EntityPopulator
{
     ...
     * @return array
     */
    public function guessColumnFormatters(\Give\Vendors\Faker\Generator $generator, Mandango $mandango)
    {
        $formatters = [];
        $nameGuesser = new \Give\Vendors\Faker\Guesser\Name($generator);
        $columnTypeGuesser = new \Give\Vendors\Faker\ORM\Mandango\ColumnTypeGuesser($generator);
