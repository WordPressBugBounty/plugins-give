...
namespace Give\Vendors\Faker\Provider\ro_RO;
...
class Person extends \Give\Vendors\Faker\Provider\Person
{
    ...
    protected function getDateOfBirth($dateOfBirth)
    {
        ...
        $baseDate = \Give\Vendors\Faker\Provider\DateTime::dateTimeBetween("first day of January {$dateOfBirthParts[0]}", "last day of December {$dateOfBirthParts[0]}");
