 ...
 * @see \Give\Vendors\Faker\Provider\ru_RU\Company
 */
class Inn
{
    /**
     ...
     * @see \Give\Vendors\Faker\Provider\ru_RU\Company::inn10Checksum()
     */
    public static function checksum($inn)
    {
        return \Give\Vendors\Faker\Provider\ru_RU\Company::inn10Checksum($inn);
    }
     ...
     * @see \Give\Vendors\Faker\Provider\ru_RU\Company::inn10IsValid()
     */
    public static function isValid($inn)
    {
        return \Give\Vendors\Faker\Provider\ru_RU\Company::inn10IsValid($inn);
    }
}
